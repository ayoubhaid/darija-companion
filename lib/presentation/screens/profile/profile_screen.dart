...
class ProfileScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final userAsync = ref.watch(mockCurrentUserProvider);
          ...
          : SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  // Level Progress
                  LevelProgressCard(user: userAsync)
                      .animate()
                  ...
                  // Statistics
                  StatisticsSection(user: userAsync)
                      .animate()
                  ...
                  // Achievements
                  AchievementsSection(user: userAsync)
                      .animate()
