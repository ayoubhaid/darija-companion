  ...
  return (
    <>
      ...
      <div className="sh-root" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 20px' }}>
        {/* Background effects */}
        <div style={{ position: 'absolute', top: '20%', right: '-10%', width: 400, height: 400, borderRadius: '50%', background: 'radial-gradient(circle, rgba(200,169,110,0.15) 0%, transparent 70%)', filter: 'blur(60px)', animation: 'float 6s ease-in-out infinite' }} />
        <div style={{ position: 'absolute', bottom: '20%', left: '-10%', width: 400, height: 400, borderRadius: '50%', background: 'radial-gradient(circle, rgba(155,114,176,0.15) 0%, transparent 70%)', filter: 'blur(60px)', animation: 'float 6s ease-in-out infinite', animationDelay: '3s' }} />
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: 440, width: '100%' }}>
          ...
          <div className="sh-card">
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
              <div>
                <label style={{ display: 'block', fontFamily: "'DM Mono',monospace", fontSize: 12, color: '#8a7a6e', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: 8 }}>Full Name</label>
                <div style={{ position: 'relative' }}>
                  <UserIcon style={{ position: 'absolute', left: 16, top: '50%', transform: 'translateY(-50%)', width: 20, height: 20, color: '#5a4a3e' }} />
                  <input
                    type="text"
              ...
              <div>
                <label style={{ display: 'block', fontFamily: "'DM Mono',monospace", fontSize: 12, color: '#8a7a6e', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: 8 }}>Confirm Password</label>
                <div style={{ position: 'relative' }}>
                  <LockClosedIcon style={{ position: 'absolute', left: 16, top: '50%', transform: 'translateY(-50%)', width: 20, height: 20, color: '#5a4a3e' }} />
                  <input
                    type="password"
          ...
          <p style={{ marginTop: 24, textAlign: 'center', fontFamily: "'Lora',serif", fontSize: 14, color: '#6a5a4e' }}>
            Already have an account?{' '}
            <Link href="/login" className="sh-link" style={{ fontWeight: 600 }}>
              Sign in
            </Link>
          </p>

          <p style={{ marginTop: 16, textAlign: 'center', fontFamily: "'DM Mono',monospace", fontSize: 11, color: '#5a4a3e' }}>
            By signing up, you agree to our{' '}
            <Link href="/terms" className="sh-link">Terms</Link>
            {' '}and{' '}
            <Link href="/privacy" className="sh-link">Privacy Policy</Link>
          </p>
        </div>
      </div>
    </>
